    ...
    try:
        ...
        if result.stdout:
            ...
            if parsed_messages:
                ...
                ver_code_list = [int(word) for word in latest_sms[0].split() if word.isdigit()]
                ver_code = ver_code_list[0]
                return ver_code  # Return the body of the latest SMS
...
if __name__ == "__main__":
    ...
    #
    # output = latest_sms
    # ver_code_list = [int(word) for word in output.split() if word.isdigit()]
    # ver_code = ver_code_list[0]
    # print(ver_code)
